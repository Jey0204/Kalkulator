...
struct ContentView: View {
    ...
    func procent(_ text: inout String) {
        
        if text.isEmpty || text == " " || text == "0,0" || text == "0" {
            return
        }
        ...
        if let number = Double(text.replacingOccurrences(of: ",", with: ".")) {
            ...
            text = String(result).replacingOccurrences(of: ".", with: ",")
        }
    }
    ...
    func zmianaZnaku(_ text: inout String){
